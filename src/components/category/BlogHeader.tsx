  ...
  return (
    <div className="text-center pb-8 space-y-4">
      ...
      <h1 className="text-5xl md:text-7xl font-light text-gray-900 tracking-tight" style={{ fontFamily: 'MuseoModerno, sans-serif' }} >
        Xtracta<span className="text-blue-600 text-5xl font-normal"> blog</span>
      </h1>
      ...
      <div className="max-w-2xl mx-auto pt-6 relative">
        <div className="relative flex items-center group">
            ...
            <input 
              ...
              className="w-full bg-gray-100 hover:bg-white focus:bg-white text-gray-700 rounded-full py-3 pl-12 pr-4 focus:outline-none focus:ring-2 focus:ring-blue-100 transition-all border border-transparent focus:border-blue-200 font-medium"
            />
        </div>
      </div>
    </div>
